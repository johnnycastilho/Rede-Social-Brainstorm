...
<title>Brainstorm - Mapa de Site</title>
<link rel="stylesheet" type="text/css" href="css/topo.css" />
<link rel="stylesheet" type="text/css" href="css/conteudo_mapasite.css" />
...
<div id="pagina">
        ...
        <div id="mapasite">
            ...
            <img class="img1" src="images/grade_mapasite.png" height="583" width="260" />
            <img class="img2" src="images/grade_mapasite2.png" height="483" width="422" />
            
            <a class="home" href="home.php">Página Principal</a>
            <a class="quemsomos" href="quemsomos.php">Quem Somos</a>
            <a class="cursos" href="infoweb_cursos.php">Cursos</a>
            <a class="instituicao" href="instituicao.php">Instituição</a>
            <a class="depoimento" href="depoimentos.php">Depoimentos</a>
            
            <a class="infoweb" href="infoweb_cursos.php">Informática para Internet</a>
            <a class="info" href="info_cursos.php">Informática</a>
            <a class="nut" href="nut_cursos.php">Nutrição e Dietética</a>
            <a class="adm" href="adm_cursos.php">Administração</a>
            <a class="sec" href="sec_cursos.php">Secretariado</a>
