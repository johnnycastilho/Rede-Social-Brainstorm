...
<div id="pagina">
        ...
        <div id="conteudo">
                ...
                <img class="img_principal" src="images/infoweb_img.png" /><br /><br />
                
                <h3 align="justify">
                O curso de informática pra internet oferecido pela ETEC desenvolve e realiza manutenção em Websites, portais na internet e intranet. Utiliza diversas ferramentas de desenvolvimento de projetos, ensinando linguagens de programação como HTML, PHP, Javascript, CSS e etc.
Além de oferecer soluções que auxiliam o processo de criação de interfaces e aplicativos empregados no comércio e marketing eletrônicos.
E o que mais pode incentivar o aluno a fazer o curso é o fato de que hoje em dia a profissão de programador web, que está em falta no mercado de trabalho, o que faz as empresas abrir muitas oportunidades pra quem exerce nesta área.
