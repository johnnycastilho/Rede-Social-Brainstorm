...
<div id="pagina">
            ...
            <div id="conteudo">
            					...
            					<div id="filtro_cursos">
                                	<form action="" method="get">
                                	<ul>
                                    	<li><input type="submit" name="filter" value="Informática" /></li>
                                        <li><input type="submit" name="filter" value="Nutrição" /></li>
                                        <li><input type="submit" name="filter" value="Administração" /></li>
                                        <li><input type="submit" name="filter" value="Secretariado" /></li>
                                        <li><input type="submit" name="filter" value="Informática para Internet" /></li>
                                     </ul>
                                     </form>
                                </div>
                               ...
                               <?php
							   	...
							   	include ("exibe_post_timeline.php");
							   ?>                    
