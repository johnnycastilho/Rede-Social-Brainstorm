...
<div id="pagina">
            ...
            <div id="conteudo">
                    ...
                    <div id="capa_grupo">
                      ...
                      <!--Area de fotos do album -->
                      
                      	<form method="post" class="form_upload" enctype="multipart/form-data">
                        
                        <input type="file" name="img_upload" />
                        <input type="hidden" name="cod_grupo" value="<?php echo "$result_codgrupo_user"; ?>" />
                        <input type="submit" name="send_image" value="Carregar Imagem" />
                        
                        </form>
                        
                        <?php				
							include('funcao_upload_image.php'); //logica para upload de imagens no servidor							
						?>
                      	...
                      	<div id="foto_album">
                        			...
                        			<a href="javascript:" id="clicar">
                                                 
                                    
                                    <?php
									
										include('exibir_foto_album.php') //logica para exibição das imagens de acordo com o diretorio
                        ...
                        <div id="container">
        						<div id="centro">
                                    ...
                                    <a href="javascript:;" id="fechar" class="fechar"><img class="exit_img" src="images/img`_exit.png" /></a>
                                    
                                    	<img src="" class="img_large" name="img_amp" />
