...
<div id="pagina">
            ...
            <div id="conteudo">
				 ...
				 $id_usuario_amigo = $_GET['id_usuario_amigo'];
				 		...
				 		$busca_nome_amigo = mysql_query("SELECT id_usuario,nome_usuario,cod_grupo FROM usuario WHERE id_usuario = '$id_usuario_amigo'");
    	...
    	<form action="" method="post" >
        	...
        	<table>
            <tr>
            <td><label>Nome de Perfil :</label></td> <td> <input name="new_name" type="text" size="50" /><br></td>
            </tr>
            
            <tr>
            <td><label>Instituição :</label></td> <td><input type="text" name="new_inst" size="50" /><br></td>
            </tr>
            
            <tr>
            <td><label>Curso :</label></td> <td><input type="text" name="new_curso" size="50"/><br></td>
            </tr>
            
            <tr>
            <td><label>Modulo :</label></td> <td><input type="text" name="new_modulo" size="50" /><br></td>
            </tr>
            
            <tr>
            <td><label>Objetivo :</label></td> <td class="textarea"><textarea rows="6" cols="50"></textarea></td>
            </tr>
    ...
    <!--Formulario de edição do perfil -->
                    ...
                    <!--alinhamento das postagens -->
							   ...
							   include ("exibe_post_perfil_amigo.php");
