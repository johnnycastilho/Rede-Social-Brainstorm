...
<link rel="stylesheet" type="text/css" href="css/conteudo_postagem.css" />
            ...
            <div id="conteudo">
            	...
            	<div id="form_postagem">
                	...
                	<h1>Postagem</h1>
                		...
                		<form action="upload_postagem_files.php" method="post" enctype="multipart/form-data">
                
                	
                    <label>Anexo :</label><input class="anexo_post" type="file" name="anexo_post" /><br><br>
                    <textarea name="conteudo_post" cols="90" rows="20" maxlength="300"></textarea><br><br>
                    <input type="hidden" name="user" value="<?php echo "$id_user"; ?>" />
                    	...
                    	<input type="submit" class="submit" name="enviar_post" value="Postar" />
                </form>
                </div>
