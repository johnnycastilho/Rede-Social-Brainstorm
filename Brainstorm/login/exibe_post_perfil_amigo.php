<?php
	...
	$busca_nome = "SELECT id_postagem,id_usuario,conteudo_postagem FROM postagem WHERE id_usuario = '$id_usuario_amigo'"; //busca do conteudo das postagens do usuario logado
	
	$busca_nome_user = "SELECT id_usuario,nome_usuario FROM usuario WHERE id_usuario = '$id_usuario_amigo'";
