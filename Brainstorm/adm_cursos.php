...
<div id="pagina">
        ...
        <div id="conteudo">
                ...
                <h3 align="justify">
                O curso de Administração oferecido na ETEC ensina ao aluno a adotar uma postura ética na rotina administrativa, elaborar planejamentos de produção e materiais, recursos humanos, mercadológicos e financeiros. Realiza atividades de controle, além de auxiliar em processos de direção, utilizando ferramentas da informática básica.  	É um curso muito concorrido, referente a busca de profissionais que existe no mercado, além do fato de ser um curso a nível técnico, o que aumenta mais ainda a expectativa de contratação das empresas como instituições públicas, privadas e do terceiro setor.
                </h3>
                </div>
